import{_ as e,W as i,X as o,Y as n,Z as a,a0 as l,$ as c,F as t}from"./framework-f7711481.js";const p={},r=n("p",null,[a("假设我们要从"),n("code",null,"program1.c"),a("、"),n("code",null,"program2.c"),a("、"),n("code",null,"main.c"),a("编译出目标文件"),n("code",null,"test")],-1),d={href:"https://blog.csdn.net/Nire_Yeyu/article/details/106373974",target:"_blank",rel:"noopener noreferrer"},u=c(`<h1 id="第一阶段-基本语法" tabindex="-1"><a class="header-anchor" href="#第一阶段-基本语法" aria-hidden="true">#</a> 第一阶段：基本语法</h1><p>Makefile的基本语法有两条：</p><ol><li><code>[目标文件]:[依赖文件]</code>（注意：顶层文件依赖关系放上面，被依赖的文件的依赖关系放下面。因为程序是按照递归的方式进行依赖文件查找的，看到第一行有一个没见过的依赖文件，就往下一行进行查找）</li><li><code>[TAB]要执行的指令</code></li></ol><p>清除编译过程中的中间文件，可以使用标志位<code>.PHONY</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>test: program1.o program2.o main.o
...
<span class="token target symbol">clean</span><span class="token punctuation">:</span>
	rm <span class="token variable">$</span><span class="token punctuation">(</span>OBJ<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13);function v(m,b){const s=t("ExternalLinkIcon");return i(),o("div",null,[n("blockquote",null,[r,n("p",null,[a("教程来自于"),n("a",d,[a("CSDN"),l(s)]),a("，感谢原作者的总结！")])]),u])}const g=e(p,[["render",v],["__file","makefile.html.vue"]]);export{g as default};
